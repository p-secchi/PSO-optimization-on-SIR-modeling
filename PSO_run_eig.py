...
for n in range(It):
    ...
    for l in range(SG):
        ...
        if n == 0:
            for i in range(len(TMN)):
                BMNL.append(Beta[n][l][i] + r1*Beta[n][l][i] + r2*(Beta[n][BestP[n][l]][i]-Beta[n][l][i]) + r3*(Beta[n][BestG[0][1]][i]-Beta[n][l][i]))
            y = Gamma[n][l] + r1*Gamma[n][l] + r2*(Gamma[n][BestP[n][l]]-Gamma[n][l]) + r3*(Gamma[n][BestG[0][1]]-Gamma[n][l])
        else:
            for i in range(len(TMN)):
                BMNL.append(Beta[n][l][i] + r1*(Beta[n-1][l][i]-Beta[n][l][i]) + r2*(Beta[n][BestP[n][l]][i]-Beta[n][l][i]) + r3*(Beta[BestG[n][0]][BestG[n][1]][i]-Beta[n][l][i]))
            y = Gamma[n][l] + r1*(Gamma[n-1][l]-Gamma[n][l]) + r2*(Gamma[n][BestP[n][l]]-Gamma[n][l]) + r3*(Gamma[BestG[n][0]][BestG[n][1]]-Gamma[n][l])
        for i in range(len(TMN)):
            if BMNL[i] > 1:
                BMN.append(1)
            elif BMNL[i]  < 0:
...
for i in range(len(NI_t_real)-1):
    if i == 0:
...
Diff = 0
IN_ges = 0
for j in range(len(NI_t_real)-1):
